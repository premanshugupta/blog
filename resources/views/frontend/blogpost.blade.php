	    ...
	    <article class="blog-post px-3 py-5 p-md-5">
		    <div class="container">
			    ...
			    <div class="blog-post-body">
                    ...
                    {
                        @endphp
				    <img class="img-fluid" src="{{url('/upload/'.$dars->bpimage)}}" alt="image" >
                    @php
                }		
                else
                {
...
export  $initHighlight;
				    ...
				    <p><!-- Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Aenean commodo ligula eget dolor. Aenean massa. Cum sociis natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus. --> {{$dars->typography}}</p>
				    <h5 class="my-3">Bullet Points:</h5>
				    <ul class="mb-5">
					  <li class="mb-2"><!-- Lorem ipsum dolor sit amet consectetuer. --> {{$dars->bulletpoint}}</li>
					...
					<blockquote class="blockquote m-lg-5 py-3 pl-4 px-lg-5">
						<p class="mb-2"><!-- You might not think that programmers are artists, but programming is an extremely creative profession. It's logic-based creativity. --> {{$dars->quoteexample}} </p>
...
<script async src="https://platform.twitter.com/widgets.js" charset="utf-8"></script>
				    ...
				    <p><!-- Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Aenean commodo ligula eget dolor. Aenean massa. Cum sociis natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus. Donec quam felis, ultricies nec, pellentesque eu, pretium quis, sem. Nulla consequat massa quis enim. -->{{$dars->videocontent}} </p>
                       @endforeach
