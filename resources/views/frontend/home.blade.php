		    ...
		    <div class="container">
			    <div class="item mb-5">
				    <div class="media">
					    ...
					    <div class="media-body">
						    ...
						    <a class="more-link" href="{{url('blogpost')}}">Read more &rarr;</a>
					    </div><!--//media-body-->
				    </div><!--//media-->
			    </div><!--//item-->
			    <div class="item mb-5">
			    ...
			    <nav class="blog-nav nav nav-justified my-5">
				 <!--  <a class="nav-link-prev nav-item nav-link d-none rounded-left" href="#">Previous<i class="arrow-prev fas fa-long-arrow-alt-left"></i></a> -->
				  <a class="nav-link-next nav-item nav-link rounded" href="{{url('bloglist')}}">Next<i class="arrow-next fas fa-long-arrow-alt-right"></i></a>
				</nav>
